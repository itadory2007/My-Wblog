...
func (r *PostRepository) GetPublicPosts(ctx context.Context,) ([]models.Post, error) {
...
func (r *PostRepository) GetPostsForUser(ctx context.Context, userID int64,) ([]models.Post, error) {
	rows, err := r.db.Query(ctx,
		`SELECT DISTINCT
			p.id,
			p.title,
...
func (r *PostRepository) DeletePost(ctx context.Context, postID int64, userID int64,) error {
